    ...
    if firstinput == 'ДА':
        ...
        while my_while:
            ...
            if a1 == 'ДА':
                ...
                print('Вы ввели не корректную информацию!') 
        print('Но вдруг, у Димы начало булькать. Он приготовился и начал по тихоньку вытаскивать рыбу.')
        time.sleep(2)
                    ...
                    if thirdinput == 'ПОПЛЫТЬ ЗА БИМОМ':
                        ...
                        while my_while:
                            ...
                            if a1 == 'ДА':
                                ...
                                print('Но ведь ситория уже закончилась.')
                            else:
                                print('Вы ввели не корректную информацию!')  
